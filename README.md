...
Adding a new screen?
- Save the screenshot to Assets/ with the screen name (e.g., MyScreen.png).
- Add a new section like:

```
## My Screen
A short purpose-driven description of what this screen helps you do.

![MyScreen](Assets/MyScreen.png)
...
If you’d like a condensed one-page brochure version for clients or marketplaces, we can generate it based on these screenshots—just ask.
